...
class ObstacleDistanceEstimator:
    ...
    _FOCAL_LENGTH = 4917  # manually calculate with example images 9 pixel height for distance 6m and real height 6cm
    # F = (P x D) /W P: Pixel width, D: distance, W: known width, F: perceived focal lenght =>  (9pixel * 6m) / 0.06m
    # = 900
